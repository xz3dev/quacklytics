...
<Aside type="note">
    The following is an overview of the motivations and methods that drive Quacklytics.

    If you'd prefer to get started immediately, check out our [Docker deployment guide](/start-here/docker).
</Aside>
